 ...
 * Description:       Redirect your visitors according to their geographical (country) location. Using the Maxmind GeoIP (Lite) Database (DB Last Updated : 2025-09-02).
 * Version:           2.0.4
 ...
 */
define( 'ADV_GEOIP_REDIRECT_PLUGIN_VERSION', '2.0.4' );
